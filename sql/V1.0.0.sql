...
CREATE TABLE `c_device`  (
  ...
  `related_location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '关联区域位置',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '设施设备表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for c_rsdevice
-- ----------------------------
DROP TABLE IF EXISTS `c_rsdevice`;
CREATE TABLE `c_rsdevice`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
  `device_id` bigint NOT NULL COMMENT '设备id',
  `parent_device_id` bigint NOT NULL COMMENT '父设备id',
  `bus_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '总线名称',
  `bus_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '总线code',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  `deleted` tinyint(1) NOT NULL DEFAULT 0 COMMENT '删除状态（0正常 1删除）',
  `creator` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '创建者',
  `creator_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  ...
  `modifier_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_device_parent`(`device_id` ASC, `parent_device_id` ASC) USING BTREE,
  INDEX `idx_device_id`(`device_id` ASC) USING BTREE,
  INDEX `idx_parent_device_id`(`parent_device_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '设备关系表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of c_rsdevice
-- ----------------------------
...
INSERT INTO `g_project` VALUES (73, '123124', '[zhejiang, hangzhou, gongshu, hushu]', 'zhejiang', 'hangzhou', 'gongshu', 'hushu', '杭电路1号杭州电子科技大学信息工程学院', '张三', NULL, 0, '', '2025-10-05 18:22:19', '', '2025-10-05 18:22:19');
...
) ENGINE = InnoDB AUTO_INCREMENT = 74 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '区域表' ROW_FORMAT = Dynamic;
...
INSERT INTO `g_zone` VALUES (73, '3123', 1, 1, NULL, NULL, NULL, '张三', NULL, NULL, NULL, NULL, NULL, NULL, 0, '', '2025-10-05 18:22:19', '', '2025-10-05 18:22:19');
...
INSERT INTO `gen_table` VALUES (6, 'c_device', '设施设备表', NULL, NULL, 'CDevice', 'crud', '', 'com.ruoyi.system', 'system', 'device', '设施设备', 'ruoyi', '0', '/', NULL, 'admin', '2025-09-21 17:23:57', '', NULL, NULL);
INSERT INTO `gen_table` VALUES (7, 'c_rsdevice', '设备关系表', NULL, NULL, 'CRsdevice', 'crud', '', 'com.ruoyi.system', 'system', 'rsdevice', '设备关系', 'ruoyi', '0', '/', NULL, 'admin', '2025-09-21 17:23:57', '', NULL, NULL);
...
INSERT INTO `gen_table` VALUES (13, 'g_category', '类别表', NULL, NULL, 'GCategory', 'crud', '', 'com.ruoyi.system', 'system', 'category', '类别', 'ruoyi', '0', '/', NULL, 'admin', '2025-09-21 17:24:15', '', NULL, NULL);
...
INSERT INTO `gen_table_column` VALUES (48, 6, 'id', '主键，自增', 'bigint', 'Long', 'id', '1', '1', '0', '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (49, 6, 'name', '名称', 'varchar(100)', 'String', 'name', '0', '0', '1', '1', '1', '1', '1', 'LIKE', 'input', '', 2, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (50, 6, 'category_id', '所属类别 c_category表关联', 'bigint', 'Long', 'categoryId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 3, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (51, 6, 'project_id', '所属项目', 'bigint', 'Long', 'projectId', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 4, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (52, 6, 'zone_id1', '所属区域1', 'bigint', 'Long', 'zoneId1', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 5, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (53, 6, 'zone_id2', '所属区域2', 'bigint', 'Long', 'zoneId2', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 6, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (54, 6, 'location', '具体位置', 'varchar(255)', 'String', 'location', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 7, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (55, 6, 'related_location', '关联区域位置', 'varchar(255)', 'String', 'relatedLocation', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 8, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (56, 6, 'brand', '品牌', 'varchar(50)', 'String', 'brand', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 9, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (57, 6, 'model', '型号', 'varchar(50)', 'String', 'model', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 10, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (58, 6, 'is_host', '是否主机（0否，1是）', 'tinyint(1)', 'Integer', 'isHost', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 11, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (59, 6, 'is_bus', '是否总线（0否，1是）', 'tinyint(1)', 'Integer', 'isBus', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 12, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (60, 6, 'production_date', '生产日期', 'date', 'Date', 'productionDate', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'datetime', '', 13, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (61, 6, 'start_date', '启用时间', 'date', 'Date', 'startDate', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'datetime', '', 14, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (62, 6, 'warranty_start', '质保开始时间', 'date', 'Date', 'warrantyStart', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'datetime', '', 15, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (63, 6, 'service_life', '使用期限（年）', 'int', 'Long', 'serviceLife', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 16, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (64, 6, 'device_status', '设备状态（1-正常，2-异常，3-修理中，4-待复检）', 'tinyint', 'Long', 'deviceStatus', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'radio', '', 17, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (65, 6, 'bind_status', '绑定状态（1-未绑定，2-已绑定）', 'tinyint', 'Long', 'bindStatus', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'radio', '', 18, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (66, 6, 'qr_code', '二维码编号', 'varchar(50)', 'String', 'qrCode', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 19, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (67, 6, 'qr_url', '二维码url', 'varchar(255)', 'String', 'qrUrl', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 20, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (68, 6, 'diagram_2d', '2d图信息', 'varchar(255)', 'String', 'diagram2d', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 21, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (69, 6, 'lng', '经度', 'decimal(10,6)', 'BigDecimal', 'lng', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 22, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (70, 6, 'lat', '纬度', 'decimal(10,6)', 'BigDecimal', 'lat', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 23, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (71, 6, 'remark', '备注', 'varchar(255)', 'String', 'remark', '0', '0', '0', '1', '1', '1', NULL, 'EQ', 'input', '', 24, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (72, 6, 'deleted', '删除状态（0正常 1删除）', 'tinyint(1)', 'Integer', 'deleted', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 25, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (73, 6, 'creator', '创建者', 'varchar(32)', 'String', 'creator', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 26, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (74, 6, 'creator_time', '创建时间', 'datetime', 'Date', 'creatorTime', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'datetime', '', 27, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (75, 6, 'modifier', '修改者', 'varchar(32)', 'String', 'modifier', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 28, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (76, 6, 'modifier_time', '修改时间', 'datetime', 'Date', 'modifierTime', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'datetime', '', 29, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (77, 7, 'id', '主键，自增', 'bigint', 'Long', 'id', '1', '1', '0', '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (78, 7, 'device_id', '设备id', 'bigint', 'Long', 'deviceId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (79, 7, 'parent_device_id', '父设备id', 'bigint', 'Long', 'parentDeviceId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 3, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (80, 7, 'bus_name', '总线名称', 'varchar(50)', 'String', 'busName', '0', '0', '0', '1', '1', '1', '1', 'LIKE', 'input', '', 4, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (81, 7, 'bus_code', '总线code', 'varchar(50)', 'String', 'busCode', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 5, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (82, 7, 'remark', '备注', 'varchar(255)', 'String', 'remark', '0', '0', '0', '1', '1', '1', NULL, 'EQ', 'input', '', 6, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (83, 7, 'deleted', '删除状态（0正常 1删除）', 'tinyint(1)', 'Integer', 'deleted', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 7, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (84, 7, 'creator', '创建者', 'varchar(32)', 'String', 'creator', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 8, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (85, 7, 'creator_time', '创建时间', 'datetime', 'Date', 'creatorTime', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'datetime', '', 9, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (86, 7, 'modifier', '修改者', 'varchar(32)', 'String', 'modifier', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 10, 'admin', '2025-09-21 17:23:57', '', NULL);
INSERT INTO `gen_table_column` VALUES (87, 7, 'modifier_time', '修改时间', 'datetime', 'Date', 'modifierTime', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'datetime', '', 11, 'admin', '2025-09-21 17:23:57', '', NULL);
...
INSERT INTO `gen_table_column` VALUES (171, 13, 'id', '主键，自增', 'bigint', 'Long', 'id', '1', '1', '0', '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2025-09-21 17:24:15', '', NULL);
INSERT INTO `gen_table_column` VALUES (172, 13, 'cname', '类别名称', 'varchar(50)', 'String', 'cname', '0', '0', '1', '1', '1', '1', '1', 'LIKE', 'input', '', 2, 'admin', '2025-09-21 17:24:15', '', NULL);
INSERT INTO `gen_table_column` VALUES (173, 13, 'pid', '父节点', 'bigint', 'Long', 'pid', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 3, 'admin', '2025-09-21 17:24:15', '', NULL);
INSERT INTO `gen_table_column` VALUES (174, 13, 'ctype', '结点类型（0分支，1结点）', 'tinyint(1)', 'Integer', 'ctype', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'select', '', 4, 'admin', '2025-09-21 17:24:15', '', NULL);
INSERT INTO `gen_table_column` VALUES (175, 13, 'subject_id', '所属科目id', 'bigint', 'Long', 'subjectId', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 5, 'admin', '2025-09-21 17:24:15', '', NULL);
INSERT INTO `gen_table_column` VALUES (176, 13, 'cicon', '图示', 'varchar(255)', 'String', 'cicon', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 6, 'admin', '2025-09-21 17:24:15', '', NULL);
INSERT INTO `gen_table_column` VALUES (177, 13, 'remark', '备注', 'varchar(255)', 'String', 'remark', '0', '0', '0', '1', '1', '1', NULL, 'EQ', 'input', '', 7, 'admin', '2025-09-21 17:24:15', '', NULL);
INSERT INTO `gen_table_column` VALUES (178, 13, 'deleted', '删除状态（0正常 1删除）', 'tinyint(1)', 'Integer', 'deleted', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 8, 'admin', '2025-09-21 17:24:15', '', NULL);
INSERT INTO `gen_table_column` VALUES (179, 13, 'creator', '创建者', 'varchar(32)', 'String', 'creator', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 9, 'admin', '2025-09-21 17:24:15', '', NULL);
INSERT INTO `gen_table_column` VALUES (180, 13, 'creator_time', '创建时间', 'datetime', 'Date', 'creatorTime', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'datetime', '', 10, 'admin', '2025-09-21 17:24:15', '', NULL);
INSERT INTO `gen_table_column` VALUES (181, 13, 'modifier', '修改者', 'varchar(32)', 'String', 'modifier', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 11, 'admin', '2025-09-21 17:24:15', '', NULL);
INSERT INTO `gen_table_column` VALUES (182, 13, 'modifier_time', '修改时间', 'datetime', 'Date', 'modifierTime', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'datetime', '', 12, 'admin', '2025-09-21 17:24:15', '', NULL);
...
INSERT INTO `sys_menu` VALUES (2042, '设备管理', 2041, 1, 'equipment', NULL, NULL, '', 1, 0, 'M', '0', '0', NULL, 'example', 'admin', '2025-10-08 16:28:26', '', NULL, '');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-10-08 16:11:21', '2025-09-17 10:41:42', 'admin', '2025-09-17 10:41:42', '', NULL, '管理员');
